...
CONFIG = {
    ...
    "save_frequency": 5000,     # 每多少步保存一次模型
    "model_save_dir": "PG\models",  # 模型保存路径
    "checkpoint_path": "PG\models\PG_lunarlander_step_50000.pth",     # "models/PG_lunarlander_step_xxxxx.pth" # 可选：加载检查点继续训练
    # 环境相关
    "num_frames": 4,             # 帧堆叠数量
